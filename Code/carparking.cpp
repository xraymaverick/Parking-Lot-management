// /*
// Created By : Adhiraj Singh Cheema
// Project Name : Car Parking Management System-21BCI0365
// Password For Login : OOPS
// Started On : 17/03/2024
// Completed On : 23/03/2024 
...
int login ::loginsys()
{
    ...
    {
        string password;
        cout << MAGENTA << \n\n\n\n\t\t\t\t----->  21BCI0365-Adhiraj Singh Cheema   <-----" << endl;
...
{
    cout << CYAN <<  "                        -------------> Car Parking System <-------------" << endl
         << endl;
...
void ParkingManagement ::cardetail()
{
    ...
    if (i == 0)
    {
        cout << RED << "Car With CarID " << detailid << " Not Found" << endl;
        cout << "---------------------------------------------------";
        cout << "---------------------------------------------------" << endl;
...
void ParkingManagement ::expense()
{
    ...
    if (i == 0)
    {
        cout << RED << "Car With CarID " << cexpenseid << " Not Found" << endl;
        cout << "---------------------------------------------------";
        cout << "---------------------------------------------------" << endl;
        cout << "TRY AGAIN! (Use Correct CarID)" << endl;
        cout << "---------------------------------------------------";
...
int main()
{
    ...
    while (1)
    {
        system("CLS");
        int choice;
        cout << "                        ----->Adhiraj Singh Cheema -21BCI0365- OOPS PROJECT<-----" << endl;
        cout << "                        -------------> Car Parking System-21BCI0365 <-------------" << endl
             << endl;
        cout << "---------------------------------------------------";
        cout << "---------------------------------------------------" << endl;
        ...
        case 5:
            cout << endl;
            cout << " CREATED BY : Adhiraj Singh Cheema";
            cout << endl
                 << endl;
            cout << "---------------------------------------------------";
            cout << "---------------------------------------------------" << endl;
